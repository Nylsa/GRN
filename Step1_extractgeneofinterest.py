...
# Create a function which will read the file and process the paths
...
# Input files
file_path = '/home/nylsachammartin/Documents/Clean-start/combinedTFandSignaling.csv'
matching_paths = find_matching_paths(file_path, gene_of_interest)
output_file = '/home/nylsachammartin/Documents/projects/GeneRegNetworks/NRP79_GeneRegulatoryNetworks/matching_paths_17102024.txt'
output_file_csv = '/home/nylsachammartin/Documents/projects/GeneRegNetworks/NRP79_GeneRegulatoryNetworks/matching_paths_17102024.csv'

# Output the matching paths
with open(output_file_csv, 'w') as out_file:
